...
struct OrderResponseReviewDTO: Decodable {
    let orderId: String
    ...
    init(from decoder: Decoder) throws {
        ...
        review = try container.decodeIfPresent(ReviewDTO.self, forKey: .review)
...
extension OrderResponseReviewDTO {
    
    func toEntity() -> OrderResponseReview {
        return OrderResponseReview(
            orderId: orderId,
            orderCode: orderCode,
